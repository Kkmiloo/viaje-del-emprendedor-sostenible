...
const DialogueContent = [
  {
    text: "¡Es hora de poner a prueba tu visión, ingenio y determinación! En este emocionante viaje, tomarás el papel de un emprendedor visionario que ha decidido cambiar el mundo con un enfoque innovador y sostenible. Tu misión: construir desde cero una empresa de logística y entregas, que no solo sea rentable, sino también ecológicamente responsable.",
...
export const Introduction = ({ onStart }: IntroductionProps) => {
  ...
  return (
    <motion.div
      className='relative flex flex-col items-center  justify-between w-full max-w-4xl m-auto p-10 min-h-[400px] h-auto rounded-2xl bg-gradient-to-br from-white to-gray-100 shadow-2xl border-4 border-gray-200'
      ...
      <AnimatePresence mode='wait'>
        {currentDialogueIndex < DialogueContent.length ? (
          ...
          >
            ...
            >
              {(() => {
                const CurrentIcon = DialogueContent[currentDialogueIndex].icon;
